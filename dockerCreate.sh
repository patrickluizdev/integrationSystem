...
NAME_IMAGE="nginx-real2"  # NOME DA IMAGEM PERSONALIZADA
NAME_CONTAINER="nginx-real-container2" # NOME DO CONTAINER QUE SERÁ EXECUTADO
PORT_SERVICE_CONTAINER="80" # PORTA DO CONTAINER
PORT_SERVICE_SERVER="9006"  # PORTA DA MAQUINA QUE VAI ESPELHAR A DO CONTAINER
...
CMD_CONTAINER="" #ADICIONE NO FORMATO CMD[]
RUN_CMD="apt update -y && apt install -y " #adicione o pacote antes do -y
